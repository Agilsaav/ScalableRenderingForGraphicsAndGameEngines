...
{
	Application::instance().mouseMovePress(x,y);
}

static void motionPassiveCallback(int x, int y)
{
...
{
	Application::instance().render(fps);
	glutSwapBuffers();
}
...
int main(int argc, char **argv)
{
	...
	glutPassiveMotionFunc(motionPassiveCallback);
